...
class Atri:
	def __init__(self, state: Any):
		...
		self.Places_Body = state["Places_Body"]
		...
		self.TextBox452 = state["TextBox452"]
	...
	@property
	def Places_Body(self):
		self._getter_access_tracker["Places_Body"] = {}
		return self._Places_Body
	@Places_Body.setter
	def Places_Body(self, new_state):
		self._setter_access_tracker["Places_Body"] = {}
		global default_state
		self._Places_Body = Flex(new_state, default_state["Places_Body"])
	...
	@property
	def TextBox452(self):
		self._getter_access_tracker["TextBox452"] = {}
		return self._TextBox452
	@TextBox452.setter
	def TextBox452(self, new_state):
		self._setter_access_tracker["TextBox452"] = {}
		global default_state
		self._TextBox452 = TextBox(new_state, default_state["TextBox452"])
