...
class Atri:
	...
	@property
	def Body_TnC(self):
		self._getter_access_tracker["Body_TnC"] = {}
		return self._Body_TnC
	@Body_TnC.setter
	def Body_TnC(self, new_state):
		self._setter_access_tracker["Body_TnC"] = {}
		global default_state
		self._Body_TnC = Flex(new_state, default_state["Body_TnC"])
